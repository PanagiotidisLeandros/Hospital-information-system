...
import java.sql.*;
public class Delete_Prescription extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Διαγραφή Συνταγής");

        jLabel1.setText("ΦΟΡΜΑ ΔΙΑΓΡΑΦΗΣ ΔΕΔΟΜΕΝΩΝ");

        jLabel2.setText("Κωδικός Συνταγής:");
    ...
    try {
        CallableStatement callableStatement  = dbConnection.prepareCall("{call delete_prescription(?)}");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Delete_Prescription.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Delete_Prescription().setVisible(true);
            }
        });
    }
