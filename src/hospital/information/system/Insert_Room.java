...
public class Insert_Room extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("(Single ,Double ,ICU)");

        jLabel6.setText("(Cleaned ,Requires maintenance)");

        jLabel8.setText("Τύπος Δωματίου:");
    ...
    int rcode = Integer.valueOf(TFRoom_code.getText());
    ...
    Time time = null;
        ...
        try {
            ...
            Logger.getLogger(Insert_Room.class.getName()).log(Level.SEVERE, null, ex);
        }
    try {
        CallableStatement callableStatement  = dbConnection.prepareCall("{call insert_Room(?, ?, ?, ?, ?)}");
        callableStatement.setInt(1, rcode);
