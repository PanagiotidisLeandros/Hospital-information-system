...
public class Delete_Appointment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Κωδικός Ραντεβού:");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(30, 30, 30)
                        .addComponent(TFAppointment_code, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    int pcode = Integer.valueOf(TFAppointment_code.getText());
    
    try {
        CallableStatement callableStatement  = dbConnection.prepareCall("{call delete_appointment(?)}");
